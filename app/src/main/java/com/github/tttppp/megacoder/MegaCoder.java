 ...
 * characters.
 * <p>
 * The MegaCoder was originally created for use as part of rabbit-escape, but
 * has also been declared public domain, so that it may be used, without
 * attribution, by anyone who needs obfuscation slightly more powerful than
 * rot13, but less portable than base64. (For clarity, the MegaCoder is this
 * single file).
 * <p>
